                        ...
                        <div class="fashion-menu">
                            <ul class="fashion-topmenu">
                                ...
                                <ul class="fashion-submenu">
                                    <li>Living Room <i class="fa-solid fa-plus"></i></li>
                                    <li>Kitchen<i class="fa-solid fa-plus"></i></li>
                                    <li>Office <i class="fa-solid fa-plus"></i></li>
                                    <li>Home Decor <i class="fa-solid fa-plus"></i></li>
                                </ul>
                            </ul>
                            ...
                            <div class="fashion-image-main">
                                <div class="fashion-image">
                                    <img src="assets/images/advertising.jpg" alt="advertising" />
                                </div>
                            </div>
                        </div>
