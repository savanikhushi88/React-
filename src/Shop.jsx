                ...
                <div class="fashion-menu">
                    <ul class="fashion-topmenu">
                        ...
                        <ul class="fashion-submenu">
                            <li>Fashion <i class="fa-solid fa-plus"></i></li>
                            <li>Jewellary <i class="fa-solid fa-plus"></i></li>
                            <li>Furniture <i class="fa-solid fa-plus"></i></li>
                            <li>Autoparts <i class="fa-solid fa-plus"></i></li>
                        </ul>
                    </ul>
